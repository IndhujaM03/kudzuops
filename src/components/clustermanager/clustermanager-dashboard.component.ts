...
import { ClusterManagerService } from '../../services/clustermanager.service';

@Component({
  selector: 'app-clustermanager-dashboard',
  standalone: true,
  ...
  template: `
    <div class="dashboard-container">
      ...
      <div class="dashboard-header">
        <h1 class="dashboard-title">Cluster Manager Report – Comprehensive Analysis of Recruitment Performance</h1>
      </div>
      ...
      <div class="charts-grid">
        ...
        <!-- Demand by Business Heads (Pie) -->
        <div class="chart-card">
          <div class="chart-header">
            <div class="chart-title">Demand by Business Heads</div>
            <div class="chart-filters">
              <div class="filter-group">
                <label>
                  <input type="radio" name="demandBHView" value="daily" [(ngModel)]="demandBHView" (ngModelChange)="onDemandBHFilterChange()"> Daily
                </label>
                <label>
                  <input type="radio" name="demandBHView" value="weekly" [(ngModel)]="demandBHView" (ngModelChange)="onDemandBHFilterChange()"> Weekly
                </label>
                <label>
                  <input type="radio" name="demandBHView" value="monthly" [(ngModel)]="demandBHView" (ngModelChange)="onDemandBHFilterChange()"> Monthly
                </label>
              </div>
              <div class="filter-group">
                <select class="filter-dropdown-month" [(ngModel)]="demandBHMonth" (ngModelChange)="onDemandBHFilterChange()">
                  <option *ngFor="let opt of monthOptions" [value]="opt.value">{{ opt.label }}</option>
                </select>
              </div>
            </div>
          </div>
          <div id="demand-business-heads-chart" class="chart-container"></div>
        </div>

        <!-- Demand by Status (Donut) -->
        <div class="chart-card">
          <div class="chart-header">
            <div class="chart-title">Demand by Status</div>
            <div class="chart-filters">
              <div class="filter-group">
                <label>
                  <input type="radio" name="demandStatusView" value="daily" [(ngModel)]="demandStatusView" (ngModelChange)="onDemandStatusFilterChange()"> Daily
                </label>
                <label>
                  <input type="radio" name="demandStatusView" value="weekly" [(ngModel)]="demandStatusView" (ngModelChange)="onDemandStatusFilterChange()"> Weekly
                </label>
                <label>
                  <input type="radio" name="demandStatusView" value="monthly" [(ngModel)]="demandStatusView" (ngModelChange)="onDemandStatusFilterChange()"> Monthly
                </label>
              </div>
              <div class="filter-group">
        ...
        <div class="chart-card">
          <div class="chart-header">
            <div class="chart-title">Demand by Skill</div>
            <div class="chart-filters">
              <div class="filter-group">
                <label>
                  <input type="radio" name="demandSkillView" value="daily" [(ngModel)]="demandSkillView" (ngModelChange)="onDemandSkillFilterChange()"> Daily
                </label>
                <label>
                  <input type="radio" name="demandSkillView" value="weekly" [(ngModel)]="demandSkillView" (ngModelChange)="onDemandSkillFilterChange()"> Weekly
                </label>
                <label>
                  <input type="radio" name="demandSkillView" value="monthly" [(ngModel)]="demandSkillView" (ngModelChange)="onDemandSkillFilterChange()"> Monthly
                </label>
              </div>
              <div class="filter-group">
        ...
        <!-- Submissions by Business Heads (Bar) -->
        <div class="chart-card chart-card-full">
          <div class="chart-header">
            <div class="chart-title">Submissions by Business Heads</div>
            <div class="chart-filters">
              <div class="filter-group">
                <label>
                  <input type="radio" name="submissionsBHView" value="daily" [(ngModel)]="submissionsBHView" (ngModelChange)="onSubmissionsBHFilterChange()"> Daily
                </label>
                <label>
                  <input type="radio" name="submissionsBHView" value="weekly" [(ngModel)]="submissionsBHView" (ngModelChange)="onSubmissionsBHFilterChange()"> Weekly
                </label>
                <label>
                  <input type="radio" name="submissionsBHView" value="monthly" [(ngModel)]="submissionsBHView" (ngModelChange)="onSubmissionsBHFilterChange()"> Monthly
                </label>
              </div>
              <div class="filter-group">
                <select class="filter-dropdown-month" [(ngModel)]="submissionsBHMonth" (ngModelChange)="onSubmissionsBHFilterChange()">
                  <option *ngFor="let opt of monthOptions" [value]="opt.value">{{ opt.label }}</option>
                </select>
              </div>
            </div>
          </div>
          <div id="submissions-business-heads-chart" class="chart-container"></div>
        </div>

        <!-- Demand by SPOCs (Pie) -->
        <div class="chart-card">
          <div class="chart-header">
            <div class="chart-title">Demand by SPOCs</div>
            <div class="chart-filters">
              <div class="filter-group">
                <label>
                  <input type="radio" name="demandSpocsView" value="daily" [(ngModel)]="demandSpocsView" (ngModelChange)="onDemandSpocsFilterChange()"> Daily
                </label>
                <label>
                  <input type="radio" name="demandSpocsView" value="weekly" [(ngModel)]="demandSpocsView" (ngModelChange)="onDemandSpocsFilterChange()"> Weekly
                </label>
                <label>
                  <input type="radio" name="demandSpocsView" value="monthly" [(ngModel)]="demandSpocsView" (ngModelChange)="onDemandSpocsFilterChange()"> Monthly
                </label>
              </div>
              <div class="filter-group">
        ...
        <!-- Submissions by SPOCs (Bar) -->
        <div class="chart-card">
          <div class="chart-header">
            <div class="chart-title">SPOC-wise Submissions</div>
            <div class="chart-filters">
              <div class="filter-group">
                <label>
                  <input type="radio" name="submissionsSpocsView" value="daily" [(ngModel)]="submissionsSpocsView" (ngModelChange)="onSubmissionsSpocsFilterChange()"> Daily
                </label>
                <label>
                  <input type="radio" name="submissionsSpocsView" value="weekly" [(ngModel)]="submissionsSpocsView" (ngModelChange)="onSubmissionsSpocsFilterChange()"> Weekly
                </label>
                <label>
                  <input type="radio" name="submissionsSpocsView" value="monthly" [(ngModel)]="submissionsSpocsView" (ngModelChange)="onSubmissionsSpocsFilterChange()"> Monthly
                </label>
              </div>
              <div class="filter-group">
...
export class ClusterManagerDashboardComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    setTimeout(() => {
      // Load key highlights and charts together
      this.loadKeyHighlights();
    this.loadAllCharts();
    }, 100);
  }
  ...
  private loadKeyHighlights(): void {
    this.clusterManagerService.getKeyHighlights().subscribe({
      next: (data: any) => {
        console.log('Cluster Manager Key Highlights Response:', data);
        this.totalSubmissions.set(data?.total_submissions ?? 0);
        this.currentDemand.set(data?.current_demand ?? 0);
        this.numberOfBusinessHeads.set(data?.number_of_business_heads ?? 0);
        console.log('Cluster Manager Signals updated:', {
          totalSubmissions: this.totalSubmissions(),
          currentDemand: this.currentDemand(),
          numberOfBusinessHeads: this.numberOfBusinessHeads()
        });
      },
      error: (err: any) => {
        console.error('Error loading Cluster Manager key highlights:', err);
        // Set defaults on error
        this.totalSubmissions.set(0);
        this.currentDemand.set(0);
        this.numberOfBusinessHeads.set(0);
      }
    });
  }
  ...
  private loadAllCharts(): void {
    ...
    this.loadDemandByBusinessHeadsChart();
    this.loadDemandByStatusChart();
    this.loadDemandBySkillChart();
    this.loadSubmissionsByBusinessHeadsChart();
    this.loadDemandBySpocsChart();
    this.loadSubmissionsBySpocsChart();
  }

  // Filter Handlers
  onDailyTrendFilterChange(): void { this.loadDailyTrendChart(); }
  onDemandBHFilterChange(): void { this.loadDemandByBusinessHeadsChart(); }
  onDemandStatusFilterChange(): void { this.loadDemandByStatusChart(); }
  onDemandSkillFilterChange(): void { this.loadDemandBySkillChart(); }
  onSubmissionsBHFilterChange(): void { this.loadSubmissionsByBusinessHeadsChart(); }
  onDemandSpocsFilterChange(): void { this.loadDemandBySpocsChart(); }
  onSubmissionsSpocsFilterChange(): void { this.loadSubmissionsBySpocsChart(); }

  // Data Loaders + Rendering
  private loadDailyTrendChart(): void {
    const dateRange = this.getDateRange(this.dailyTrendView, this.dailyTrendMonth);
    this.clusterManagerService.getDailySubmissionsTrend(dateRange.startDate, dateRange.endDate).subscribe({
      next: (response: any) => {
  ...
  private loadDemandByBusinessHeadsChart(): void {
    const dateRange = this.getDateRange(this.demandBHView, this.demandBHMonth);
    this.clusterManagerService.getDemandByBusinessHeads(dateRange.startDate, dateRange.endDate).subscribe({
      next: (response: any) => {
        const data = response.distribution || [];
        this.renderPieChart('demand-business-heads-chart', data, 'business_head_name', 'count', 'percentage', true);
      },
      error: (err: any) => {
        console.error('Error loading demand by business heads:', err);
        this.showEmptyState('demand-business-heads-chart', 'No demand data available');
      }
    });
  }

  private loadDemandByStatusChart(): void {
    const dateRange = this.getDateRange(this.demandStatusView, this.demandStatusMonth);
    this.clusterManagerService.getDemandByStatus(dateRange.startDate, dateRange.endDate).subscribe({
      next: (response: any) => {
        const data = response.status_counts || [];
        this.renderDonutChart('demand-status-chart', data, 'status', 'count', 'percentage');
      },
      error: (err: any) => {
        console.error('Error loading demand by status:', err);
        this.showEmptyState('demand-status-chart', 'No status data available');
      }
    });
  }

  private loadDemandBySkillChart(): void {
    const dateRange = this.getDateRange(this.demandSkillView, this.demandSkillMonth);
    this.clusterManagerService.getDemandBySkill(dateRange.startDate, dateRange.endDate).subscribe({
      next: (response: any) => {
        const data = response.skill_distribution || [];
        this.renderBarChart('demand-skill-chart', data, 'skill', 'count', 'Skill', 'Demands');
      },
      error: (err: any) => {
        console.error('Error loading demand by skill:', err);
        this.showEmptyState('demand-skill-chart', 'No skill data available');
      }
    });
  }

  private loadSubmissionsByBusinessHeadsChart(): void {
    const dateRange = this.getDateRange(this.submissionsBHView, this.submissionsBHMonth);
    this.clusterManagerService.getSubmissionsByBusinessHeads(dateRange.startDate, dateRange.endDate).subscribe({
      next: (response: any) => {
        const data = response.business_head_submissions || [];
        this.renderBarChart('submissions-business-heads-chart', data, 'business_head_name', 'count', 'Business Head', 'Submissions');
      },
      error: (err: any) => {
        console.error('Error loading submissions by business heads:', err);
        this.showEmptyState('submissions-business-heads-chart', 'No submission data available');
      }
    });
  }

  private loadDemandBySpocsChart(): void {
    const dateRange = this.getDateRange(this.demandSpocsView, this.demandSpocsMonth);
    this.clusterManagerService.getDemandBySpocs(dateRange.startDate, dateRange.endDate).subscribe({
      next: (response: any) => {
        const data = response.distribution || [];
        this.renderPieChart('demand-spocs-chart', data, 'spoc_name', 'count', 'percentage', true);
      },
      error: (err: any) => {
        console.error('Error loading demand by SPOCs:', err);
        this.showEmptyState('demand-spocs-chart', 'No demand data available');
      }
    });
  }

  private loadSubmissionsBySpocsChart(): void {
    const dateRange = this.getDateRange(this.submissionsSpocsView, this.submissionsSpocsMonth);
    this.clusterManagerService.getSubmissionsBySpocs(dateRange.startDate, dateRange.endDate).subscribe({
      next: (response: any) => {
        const data = response.spoc_submissions || [];
        this.renderBarChart('submissions-spocs-chart', data, 'spoc_name', 'count', 'SPOC', 'Submissions');
      },
      error: (err: any) => {
        console.error('Error loading submissions by SPOCs:', err);
  ...
  // Rendering helpers
  private showEmptyState(containerId: string, message: string): void {
  ...
  private renderLineChart(containerId: string, data: Array<{ date: string; count: number; business_heads?: Array<{ business_head_name: string; count: number }> }>): void {
    ...
    g.selectAll('.dot')
      ...
      .on('mouseover', (event, d) => {
        const tooltipContent = `
          ...
          ${d.business_heads && d.business_heads.length > 0 ? d.business_heads.map(r => `<div class="tooltip-item">${r.business_head_name}: ${r.count}</div>`).join('') : ''}
        `;
  ...
  private renderPieChart(containerId: string, data: any[], labelKey: string, valueKey: string, percentageKey?: string, useAlternateColors: boolean = false): void {
    const container = d3.select(`#${containerId}`);
    container.selectAll('*').remove();
  ...
  private renderDonutChart(containerId: string, data: any[], labelKey: string, valueKey: string, percentageKey?: string, useAlternateColors: boolean = false): void {
    const container = d3.select(`#${containerId}`);
    container.selectAll('*').remove();
  ...
  private renderBarChart(containerId: string, data: any[], xKey: string, yKey: string, xLabel: string, yLabel: string): void {
    const container = d3.select(`#${containerId}`);
    container.selectAll('*').remove();
    ...
    const getBarColor = (d: any, index: number): string => {
      ...
      // Use recruiterChartColors for submissions by business heads chart
      if (containerId === 'submissions-business-heads-chart') {
